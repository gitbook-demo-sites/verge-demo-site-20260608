...
- Basic understanding of [VergeOS core network architecture](https://app.gitbook.com/s/XSPACE_DEPLOY/implementation-guide/concepts#core-fabric-network)
...
For more information on viewing and managing alarms, see the [Alarms Guide](https://app.gitbook.com/s/XSPACE_RUN/product-guide/operations/alarms).
...
!!! warning "Address Core Network Alarms Immediately"
    ...
    Event triggers can be configured to send notifications via email, text alerting systems, monitored Slack channels, and more, ensuring administrators are notified immediately. See the [Task Engine Product Guide](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/automation/task-engine) for more information about creating automated tasks; this [Automation Example](https://docs.verge.io/knowledge-base/automated-task-example-webhook/) KB article provides an example of setting up event-driven notifications.
...
VergeOS maintenance operations — including [system updates](https://app.gitbook.com/s/XSPACE_RUN/product-guide/operations/sop-update), [vSAN scale-ups](https://app.gitbook.com/s/XSPACE_RUN/product-guide/operations/vsan-scale-up-sop), and [scale-outs](https://app.gitbook.com/s/XSPACE_RUN/product-guide/operations/sop-scale-out) — require a healthy fabric as a prerequisite. **Do not proceed with maintenance if the fabric is unhealthy.** Resolve any issues first using the [Troubleshooting](#troubleshooting-fabric-issues) section below.
...
- [Core Concepts — Core Fabric Network](https://app.gitbook.com/s/XSPACE_DEPLOY/implementation-guide/concepts#core-fabric-network)
- [Nodes Overview](https://app.gitbook.com/s/XSPACE_RUN/product-guide/system/nodes-overview)
- [Node Diagnostics Guide](https://app.gitbook.com/s/XSPACE_RUN/product-guide/system/node-diagnostics)
- [System Update SOP](https://app.gitbook.com/s/XSPACE_RUN/product-guide/operations/sop-update)
- [vSAN Scale-Up SOP](https://app.gitbook.com/s/XSPACE_RUN/product-guide/operations/vsan-scale-up-sop)
- [Scale-Out SOP](https://app.gitbook.com/s/XSPACE_RUN/product-guide/operations/sop-scale-out)
- [Switch Configuration Guide](https://app.gitbook.com/s/XSPACE_DEPLOY/implementation-guide/switch-configuration)
