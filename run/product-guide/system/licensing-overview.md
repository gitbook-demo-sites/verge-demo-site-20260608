...
2. Contact [VergeOS Support](https://docs.verge.io/support/) and provide both the old and new System IDs.
...
- [Licensing and Software Updates](https://app.gitbook.com/s/XSPACE_RUN/product-guide/system/licensing-and-updates) — Managing updates and update server configuration
- [Verify Licensing and Update Server Configuration](https://app.gitbook.com/s/XSPACE_RUN/product-guide/system/license-updates-verify) — Troubleshooting licensing connectivity
- [System Settings Overview](https://app.gitbook.com/s/XSPACE_RUN/product-guide/system/settings-overview) — General system settings reference
