...
[Snapshot Profiles](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/backup-dr/snapshot-profiles) are used to schedule snapshots; assign a profile to a volume to perform automated snapshots.
