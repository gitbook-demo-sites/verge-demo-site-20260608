...
!!! note "Hardware Documentation"
    Refer to [VergeOS sizing documentation](https://app.gitbook.com/s/null/implementation-guide/sizing) for current and detailed requirements.
...
- [ ] Create install media per [VergeOS documentation](https://app.gitbook.com/s/null/implementation-guide/install-media)
  - [ ] Test boot media to verify functionality

- [ ] Document and Create all network requirements

!!! note "Network Documentation"
    Refer to [VergeOS network design documentation](https://app.gitbook.com/s/null/implementation-guide/network-design) for current and detailed network requirements.
...
!!! danger "Emergency Support"
    Should you have any issues with your VergeOS installation, please contact [our support team](https://docs.verge.io/support/) for immediate assistance.
