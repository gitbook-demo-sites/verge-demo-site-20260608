...
!!! warning "Drives Must Be Moved from the Original Node"
    This procedure only applies when the original drives are transferred to the replacement node. If you need to replace a node **and** its drives, contact [VergeOS Support](https://docs.verge.io/support/) for assistance.
...
1. A dialog will ask whether you are replacing the node's drives. Select **No** to indicate that the original drives have been moved into this new chassis.
    ...
    !!! info "When replacing a node along with its drives, contact [VergeOS Support](https://docs.verge.io/support/)."
...
- [Creating Bootable Installation Media](https://app.gitbook.com/s/null/implementation-guide/install-media)
