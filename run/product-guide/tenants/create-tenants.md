...
!!! tip "[KB Article: *Tenant Node Planning Guide*](https://docs.verge.io/knowledge-base/tenant-node-planning-guide/) walks through the considerations involved in deciding the number of tenant nodes to employ and RAM/Cores to assign to those tenant nodes."
...
- See [**Create a New Tenant with Proxy**](https://docs.verge.io/knowledge-base/configuring-proxy/#creating-a-new-tenant-with-proxy) for instructions on creating a new tenant with a proxy and assigning an FQDN to it.
...
The [Tenant Recipes page](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/automation/tenant-recipes) provides information about creating and using tenant recipes.
