...
Once a deleted tenant is restored, an IP address can be reassigned to it. For more information see: [**Assigning External IP Addresses to a Tenant**](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/assign-ip-to-tenant)
