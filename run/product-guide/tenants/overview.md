...
1. **[Create your first tenant](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/create-tenants)** - Set up a basic tenant environment
2. **[Assign external access](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/assign-ip-to-tenant)** - Provide network connectivity
3. **[Configure monitoring](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/tenant-monitoring)** - Set up oversight and reporting
...
- **Automated Deployment:** [Tenant Recipes](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/automation/tenant-recipes) allow for rapid deployment, compliance, self-service applications, etc.
- **Custom Branding:** Parent systems can permit a tenant to "brand" its user interface with its own company logos, color schemes and font selections, using [**Themes**](https://app.gitbook.com/s/XSPACE_RUN/product-guide/system/themes) (can be allowed/disallowed on a per-tenant basis) 
...
### Getting Started
- [Creating Tenants](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/create-tenants)
- [Assigning External IP Addresses](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/assign-ip-to-tenant)
- [Modifying Tenant Properties](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/tenant-modifications)

### Resource Management  
- [Increasing Tenant Resources](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/add-tenant-resources)
- [Reducing Tenant Resources](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/reduce-tenant-resources)
- [Tenant Usage Reports](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/tenant-usagereports)

### Data Sharing & Protection
- [Sharing Files with Tenants](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/provide-files-to-tenant)
- [Sharing VMs with Tenants](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/share-vm-snapshot)
- [Tenant Snapshots](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/tenant-snapshots)
- [Tenant Restores](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/tenant-restores)

### Monitoring & Management
- [Monitoring Tenants](https://app.gitbook.com/s/XSPACE_RUN/product-guide/tenants/tenant-monitoring)
