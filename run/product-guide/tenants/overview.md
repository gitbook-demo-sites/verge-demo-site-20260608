...
1. **[Create your first tenant](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/tenants/create-tenants)** - Set up a basic tenant environment
2. **[Assign external access](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/tenants/assign-ip-to-tenant)** - Provide network connectivity
3. **[Configure monitoring](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/tenants/tenant-monitoring)** - Set up oversight and reporting
...
- **Custom Branding:** Parent systems can permit a tenant to "brand" its user interface with its own company logos, color schemes and font selections, using [**Themes**](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/system/themes) (can be allowed/disallowed on a per-tenant basis) 
...
### Getting Started
- [Creating Tenants](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/tenants/create-tenants)
- [Assigning External IP Addresses](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/tenants/assign-ip-to-tenant)
- [Modifying Tenant Properties](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/tenants/tenant-modifications)

### Resource Management  
- [Increasing Tenant Resources](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/tenants/add-tenant-resources)
- [Reducing Tenant Resources](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/tenants/reduce-tenant-resources)
- [Tenant Usage Reports](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/tenants/tenant-usagereports)

### Data Sharing & Protection
- [Sharing Files with Tenants](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/tenants/provide-files-to-tenant)
- [Sharing VMs with Tenants](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/tenants/share-vm-snapshot)
...
- [Monitoring Tenants](https://app.gitbook.com/s/pODKGSQETqL1gSqyxIq3/product-guide/tenants/tenant-monitoring)
