...
1. **Establish desired VM snapshot**: [Take a manual snapshot of the VM](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/backup-dr/vm-snapshots-restores#take-a-manual-snapshot-of-a-vm) or determine an existing VM snapshot you wish to use.
