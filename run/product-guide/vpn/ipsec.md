...
* [Dedicated Public Address with Bridged Internal Network](https://docs.verge.io/knowledge-base/ipsec-example-dedicated-ip/)  
* [Tenant Using NAT-translated UI Address ](https://docs.verge.io/knowledge-base/ipsec-example-tenant-nat-ui-ip/)
