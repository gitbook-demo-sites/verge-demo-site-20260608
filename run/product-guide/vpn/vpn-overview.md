...
A secure tunnel connection can be established between VergeOS sites or from a VergeOS site to a third-party WireGuard peer; reference the site-to-site instructions on: [**WireGuard**](https://app.gitbook.com/s/null/product-guide/vpn/wireguard-config). Example Site-to-Site WireGuard configurations can be viewed at [**WireGuard Configuration Examples**](https://app.gitbook.com/s/null/product-guide/vpn/wireguard-examples).

## VPN for Secure Remote User Access to a VergeOS Site
To configure a secure tunnel for remote users to access a VergeOS system, consult the WireGuard Configuration page: [**WireGuard**](https://app.gitbook.com/s/null/product-guide/vpn/wireguard-config) and the [**WireGuard Configuration Examples**](https://app.gitbook.com/s/null/product-guide/vpn/wireguard-examples) for sample remote access configurations.
...
Information on creating a VPN tunnel to a third-party IPsec peer can be found at: [**IPsec Configuration**](https://app.gitbook.com/s/null/product-guide/vpn/ipsec)