...
19. **Additional Optional Fields:**  See [**Authorization Sources (General)**](https://app.gitbook.com/s/XSPACE_RUN/product-guide/auth/auth-sources-overview) for information regarding additional optional Fields.
