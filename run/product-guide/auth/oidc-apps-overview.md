...
2. [Setting Up VergeOS as an OIDC Provider](https://docs.verge.io/knowledge-base/setting-up-vergeos-as-identity-provider-oidc/)

!!! tip "Multiple OIDC applications can be created on the same system to accommodate different configurations."

3. [Configuring VergeOS as an OIDC Client](https://docs.verge.io/knowledge-base/configuring-vergeos-as-oidc-client/)
