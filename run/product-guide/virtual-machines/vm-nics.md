...
!!! note "VMware Service VM NICs"
    VMware service VMs use a different NIC type that includes an **IPv4 Configuration** panel for assigning static IP settings. For details, see [Configuring VMware Service VM NIC IPv4 Settings](https://docs.verge.io/knowledge-base/vmware-service-vm-nic-ipv4-configuration/).
