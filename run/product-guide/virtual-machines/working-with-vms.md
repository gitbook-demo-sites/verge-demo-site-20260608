...
The [Remote Console](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-remote-console) provides video/keyboard-mouse access to your VMs through the VergeOS user interface.
...
!!! tip
    While cloning allows you to make a simple copy of a VM, [Recipes](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/automation/vm-recipes) empower you to generate new custom VM instances based on a template VM; recipe questions provide for adjusting details per instance, as it is created, such as IP address, guest username/passwords, allocated resources, networks, etc.
