...
For detailed system requirements, see the [VergeOS Installation Guide](https://app.gitbook.com/s/XSPACE_DEPLOY/implementation-guide/installation-guide).
...
- **Next step:** [Creating Your First VM](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/creating-vms)
...
- **Next step:** [VM Configuration Guide](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-field-descriptions)
...
- **Next step:** [VM Best Practices](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-best-practices)
...
- **Next step:** [VM Import Methods](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-migration-overview)
...
- **[Guest OS Compatibility](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/guest-os-compatibility)** - Supported operating systems and configurations
- **[VM Field Descriptions](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-field-descriptions)** - Complete reference for VM configuration options

### **Support**

- **[Support ](https://docs.verge.io/support/)** - Access professional support and documentation
...
- **[VM Best Practices](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-best-practices)** - Configuration guidelines and recommendations *(20 minutes)*
- **[Creating VMs](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/creating-vms)** - Step-by-step VM creation guide *(15 minutes)*
- **[Uploading Media Images](https://app.gitbook.com/s/XSPACE_RUN/product-guide/storage/uploading-files-to-vsan)** - Upload ISOs and installation media *(10 minutes)*

### VM Configuration

- **[Virtual Machine Drives](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-drives)** - Storage configuration and management
- **[Virtual Machine Network Interfaces](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-nics)** - Network connectivity setup
- **[VM Field Descriptions](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-field-descriptions)** - Complete configuration reference
- **[Guest Agent](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-guest-agent)** - Enhanced VM integration and management

### Import and Migration

- **[Import Methods Overview](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-migration-overview)** - Choose the right import method for your needs
- **[Import from VMware](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/import-from-vmware)** - VMware migration guide
- **[Import from Media Images](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/import-from-upload)** - Create VMs from disk images
- **[Import from NAS](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/import-from-nas)** - Import from network storage

### Advanced Operations

- **[Live Migrations](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/live-migrations)** - Zero-downtime VM movement
- **[Manual VM Migrations](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-manual-migration)** - Planned migration procedures
- **[Working with VMs](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/working-with-vms)** - Day-to-day VM management

### Virtual Desktop Infrastructure

- **[VDI Overview](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vdi-overview)** - Native VDI capabilities
- **[VDI Administration](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vdi-administrator)** - Admin guide for VDI deployments
- **[Remote Console Access](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-remote-console)** - VM console connectivity

### Backup and Recovery

- **[VM Snapshots and Restores](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/backup-dr/vm-snapshots-restores)** - Backup and recovery strategies

### Automation

- **[Recipes Overview](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/automation/recipes-overview)** - Automated VM deployment templates
- **[Task Engine](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/automation/create-tasks)** - Scheduled automation and workflows  
