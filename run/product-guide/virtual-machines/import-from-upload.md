...
1. Upload configuration and disk image files to the vSAN. For instructions on uploading files to the vSAN, see [**Uploading Files to the vSAN**](https://app.gitbook.com/s/XSPACE_RUN/product-guide/storage/uploading-files-to-vsan).
...
7. Select ***Preferred Tier***, or leave at --default--. This determines the tier first attempted for VM storage. See the [**Preferred Tier**](https://app.gitbook.com/s/XSPACE_RUN/product-guide/storage/preferred-tiers) page for more information.
...
1. Upload disk image files to the vSAN. For instructions on uploading files to the vSAN, see [**Uploading Files to the vSAN**](https://app.gitbook.com/s/XSPACE_RUN/product-guide/storage/uploading-files-to-vsan)
2. [**Create a new Custom VM**](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/creating-vms#create-a-new-custom-vm), assigning appropriate hardware specifications and NIC device(s).
...
5. Select drive ***Media File*** (*.vhd,*.vhdx, *.qcow, raw, etc.) from the dropdown list. ([**VM Drives**](https://app.gitbook.com/s/XSPACE_RUN/product-guide/virtual-machines/vm-drives) provides detailed drive creation instructions.).
