...
!!! info "Tenant Configuration"
    For VLAN configuration within a tenant, [Virtual Switch Ports](https://docs.verge.io/knowledge-base/provide-layer2-to-tenant/) must first be configured to provide external layer 2 access to the tenant.
