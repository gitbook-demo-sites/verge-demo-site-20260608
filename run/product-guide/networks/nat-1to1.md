...
- [**Define a static (private) IP for the destination VM**](https://app.gitbook.com/s/XSPACE_RUN/product-guide/networks/dhcp-static-lease)
- [**Assign an external IP to the internal network**](https://app.gitbook.com/s/XSPACE_RUN/product-guide/networks/assign-external-ip)
