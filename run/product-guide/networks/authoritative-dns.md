...
- **[Configure Authoritative DNS in VergeOS](https://docs.verge.io/knowledge-base/configure-authoritative-dns-vergeos/)** - Complete configuration guide with detailed steps for enabling BIND DNS, creating DNS views, configuring zones, adding records, and setting up firewall rules
