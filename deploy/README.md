...
- VMware comparisons live in [Run the platform](https://app.gitbook.com/s/XSPACE_RUN/product-guide/intro/transition-from-vmware)
- Snapshot and DR follow-through lives in [Automate, protect, and extend](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/backup-dr/overview)
