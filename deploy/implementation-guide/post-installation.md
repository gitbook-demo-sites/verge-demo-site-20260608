...
* VergeOS provides configuration options for you to secure and maximize the benefits of your new system.  Follow the **[New System Configuration Checklist](https://app.gitbook.com/s/XSPACE_RUN/product-guide/intro/new-system-configuration)** in the Product Guide to finish preparing your environment for production.
...
- Contact [VergeOS Support](https://docs.verge.io/support/) for assistance
