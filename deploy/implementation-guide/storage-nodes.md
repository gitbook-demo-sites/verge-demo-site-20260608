...
* The 2 node cluster from the [Installation Guide](https://app.gitbook.com/s/null/implementation-guide/installation-guide) is installed and fully operational.
