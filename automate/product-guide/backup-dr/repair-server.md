...
!!! info  "Repair servers may be auto-generated when [**Adding Sites to the Dashboard**](https://app.gitbook.com/s/XSPACE_RUN/product-guide/system/site-dashboard-add-sites)."
