...
!!! success "System snapshots can be selected for automatic site sync; this includes full and partial (available in version 26.1) system snapshots.  See [**Snapshots Overview**](https://app.gitbook.com/s/null/product-guide/backup-dr/snapshots-overview) and [**System Snapshots**](https://app.gitbook.com/s/null/product-guide/backup-dr/system-snapshots) for more information."  
...
More information on creating automated tasks is available here: [**Create Tasks**](https://app.gitbook.com/s/null/product-guide/automation/create-tasks)
