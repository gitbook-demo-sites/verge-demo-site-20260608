...
For detailed instructions on configuring periods, see [Snapshot Profiles - Profile Periods](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/backup-dr/snapshot-profiles#profile-periods). 
...
!!! warning "Immutable snapshots cannot be deleted (even by administrators) until unlocked, and the waiting period has elapsed. Ensure retention settings align with available storage. For more guidance, refer to the [Immutable Snapshots Guide](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/backup-dr/immutable-snapshots)."  
...
* [Snapshots Overview](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/backup-dr/snapshots-overview)
* [Snapshot Profiles](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/backup-dr/snapshot-profiles)
...
* [NAS Volume Snapshots and Restores](https://app.gitbook.com/s/XSPACE_RUN/product-guide/nas/volume-snapshots-restores)
* [Site Syncs](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/backup-dr/syncs-overview)
