...
For detailed instructions on creating and configuring assistants, see the [AI Configuration Guide](https://app.gitbook.com/s/null/product-guide/private-ai/configuration#ai-assistant-management).
