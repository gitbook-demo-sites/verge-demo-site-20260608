...
!!! tip "A chat session requires a configured model and assistant; see the [AI Configuration Guide](https://app.gitbook.com/s/null/product-guide/private-ai/configuration) for setup instructions."
...
Assistant settings allow controlling chat history default settings across sessions. See [AI Assistant Management](https://app.gitbook.com/s/null/product-guide/private-ai/configuration#ai-assistant-management).  
