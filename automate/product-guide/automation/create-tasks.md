...
3. Select a **Schedule** from the dropdown list.  
   VergeOS includes several pre-installed schedules. To create a custom schedule, see the **[Schedules Guide](https://app.gitbook.com/s/null/product-guide/automation/schedules)**.
...
- [Task Engine Overview](https://app.gitbook.com/s/null/product-guide/automation/task-engine)  
- [Using Webhooks](https://app.gitbook.com/s/null/product-guide/automation/webhooks) 
- [Defining Schedules](https://app.gitbook.com/s/null/product-guide/automation/schedules) 
