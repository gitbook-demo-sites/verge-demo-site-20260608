...
!!! note "Recipes are stored in [Catalogs](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/automation/recipes-organization#catalogs). If you do not have a local catalog created yet, you will be prompted to create a new one first."  
3. **Recipe Fields**
