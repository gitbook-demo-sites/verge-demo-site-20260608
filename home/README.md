...
Start with [Run the platform -> What is VergeOS](https://app.gitbook.com/s/XSPACE_RUN/product-guide/intro/what-is-vergeos) and [Transitioning from VMware](https://app.gitbook.com/s/XSPACE_RUN/product-guide/intro/transition-from-vmware).
{% endstep %}

{% step %}
### Designing a new deployment
Move into [Plan and deploy](https://app.gitbook.com/s/XSPACE_DEPLOY/) for sizing, network design, install sequencing, and reference architectures.
{% endstep %}

{% step %}
### Operationalizing the estate
Use [Automate, protect, and extend](https://app.gitbook.com/s/XSPACE_AUTOMATE/) for snapshots, site syncs, recipes, API keys, CLI flows, and Private AI.
{% endstep %}
{% endstepper %}

## High-signal paths

- New deployment blueprint: [Implementation guide](https://app.gitbook.com/s/XSPACE_DEPLOY/implementation-guide/intro)
- VMware migration story: [Transitioning from VMware](https://app.gitbook.com/s/XSPACE_RUN/product-guide/intro/transition-from-vmware)
- Core platform concepts: [Platform capabilities](https://app.gitbook.com/s/XSPACE_RUN/product-guide/intro/platform-capabilities)
- Built-in resilience: [Backup & disaster recovery](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/backup-dr/overview)
- Automation surface: [VergeOS CLI](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/tools-integrations/vrg-cli)
- Local model hosting: [Private AI overview](https://app.gitbook.com/s/XSPACE_AUTOMATE/product-guide/private-ai/overview)

<a class="button primary" href="https://app.gitbook.com/s/XSPACE_DEPLOY/">Explore the deployment path</a>
